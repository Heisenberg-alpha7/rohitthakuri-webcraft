...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const mailto = `mailto:Heisenbergthakuri@gmail.com?subject=Message from ${form.name}&body=${encodeURIComponent(form.message)}%0A%0AFrom: ${form.email}`;
    window.open(mailto);
  };
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            <p className="text-muted-foreground leading-relaxed">
              I'd love to hear from you! Whether you have a project idea, a question, or just want to say hello — feel free to reach out.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:Heisenbergthakuri@gmail.com" className="text-foreground font-medium text-sm hover:text-primary transition-colors">
                    Heisenbergthakuri@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground font-medium text-sm">9762609494</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-foreground font-medium text-sm">Bhaktapur</p>
                </div>
              </div>
            </div>
          </motion.div>
